   	      ...
   	      public class MenudrivenslL {
    	      ...
    	      public static void main(String[] args) {
    	          ...
    	          do {
    	              ...
    	              if (choice == 1) { System.out.print("Enter value: "); list.insertAtBeginning(scanner.nextInt()); }
    	              else if (choice == 2) { System.out.print("Enter value: "); list.insertAtEnd(scanner.nextInt()); }
